...
\begin{itemize}[noitemsep]
	...
	Dieser Nachteil den die externen Suchmaschinen verstärkt sich, wenn man nach vielen Worten gleichzeitig sucht, denn dann werden keine Resultate mehr gefunden. Das gesamte Dokument ist immer nur ein Vers, also nur wenige Worte.
	...
	\item Der weitere Kontext der Nachbarsversen wird bei beiden externen Suchmaschinen ebenfalls ignoriert, was bei der umgesetzten Suchmaschine den Vorteil bringt, dass dieser Kontext das Ranking berücksichtigt.
	Durch den Kontext, werden aber auch mehrere Resultate gefunden die im Hauptvers die Suchwörter gar nicht beinhalten, weil sie nur im Kontext vorkommen. Auch diese wirken sich negativ auf die Precision aus, weil sich so die Menge an Resultate vermehrt.
...
\begin{itemize}[noitemsep]
	...
	\item Die Precision muss mit Rücksicht betrachtet werden. Bei einem Top-Ranking, darf sich die Suchmaschinen-Qualität nicht auf Grund der Anzahl Resultate verschlechtern.
	
	\item Alle Anfragen konnten grundsätzlich von allen Suchmaschinen beantwortet werden.
	
	\item Die umgesetzte Suche ist den anderen Suchen vor allem in der versorientierten Anfrage stark überlegen.
	
	\item Bezüglich der Laufzeit, waren alle Suche sehr schnell.

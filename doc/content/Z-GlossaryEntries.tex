...
\newglossaryentry{glos:indexingLabel}{
	...
	description={
		Indexierung bezeichnet die Generierungs-Phase des \gls{glos:indexLabel}es.
...
\newglossaryentry{glos:scoringLabel}{
	...
	description={
		...
		Je höher das Scoring ist, umso genauer passt das Ergebnis zur Suche.
...
\newglossaryentry{glos:wordDistanceLabel}{
	...
	plural={Wortabstände},
	description={
		Der Wortabstand lässt Rückschluss auf die Wichtigkeit eines Begriffes in einem Dokument ziehen. Wenn zum Beispiel ein Wort mehrmals innerhalb eines kleinen Wortabstandes erwähnt wird, kann eine erhöhte Wichtigkeit dieses Wortes angenommen werden.
	}
}

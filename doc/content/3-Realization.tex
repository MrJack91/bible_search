...
\begin{itemize}
	...
	\todo{Wie schreibt man Kleinbuchstaben wirklich?}
...
\begin{table}[H]
	...
	\begin{tabularx}{0.5\textwidth}{ R{0.2\linewidth} | Y }%
		\textbf{Dokumentgrösse} & \textbf{Anzahl Vorkommnisse}\\ \hline \hline
		1 & 22'886\\
		2 & 2'841\\
		3 & 481\\
		4 & 146\\
...
\vspace{0.5em}\\
\todo{Reihenfolge von Kontextberücksichtigungn und der ForceMerge überprüfen!}

...
Dabei wurden die Versen wie folgt zu neuen \glspl{glos:documentLabel}n zusammengefasst:
\begin{table}[H]
	\centering
...
Ein Nachteil der Kontextberücksichtigung ist, dass Verse die den Suchbegriff nur in den Nachbarsversen beinhalten trotzdem in der Resultat Liste erscheinen.

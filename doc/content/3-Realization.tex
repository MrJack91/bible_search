...
\todo{dieser Text ist wiederholt - notwendig?}
...
Die Optimierungen aus \secref{sec:documentOptimazing} wurden beide eingebaut.
...
Dabei wurden die Versen wie folgt zu neuen Dokumenten zusammengefasst:
\begin{table}[H]
	\centering
...
\vspace{0.5em}\\
\todo{Reihenfolge von Kontextberücksichtigungen und der ForceMerge überprüfen!}
...
\todo{Wie genau konnte durch diese Optimierung der Kontext verbessert werden?}
...
Zusätzlich für den Versuch der Kontext Optimierung (siehe \secref{sec:contextOptimaze}) sollen die Nachbarsverse ebenfalls indexiert werden. Sie werden ins Feld \textit{context} gespeichert und ebenfalls indexiert.
...
\begin{figure}[H]
	...
	\caption{Screenshot der Suche inkl. Ergebnisse}
\end{figure}
